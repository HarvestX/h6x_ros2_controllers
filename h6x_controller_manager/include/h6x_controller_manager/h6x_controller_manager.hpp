...
#include "h6x_controller_manager/controller_spec.hpp"
#include "h6x_controller_manager/visibility_control.h"
...
{
using ControllersListIterator = std::vector<h6x_controller_manager::ControllerSpec>::const_iterator;
...
public:
  ...
  ControllerManager(
    ...
    const std::string & manager_node_name = "h6x_controller_manager",
...
private:
  ...
  std::shared_ptr<pluginlib::ClassLoader<h6x_controller_interface::ControllerInterface>> loader_;
