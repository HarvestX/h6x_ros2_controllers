...
#include "h6x_controller_manager/h6x_controller_manager.hpp"
...
namespace  // utility
{
static constexpr const char * kControllerInterfaceNamespace = "h6x_controller_interface";
static constexpr const char * kControllerInterfaceClassName =
  "h6x_controller_interface::ControllerInterface";
...
bool controller_name_compare(
  const h6x_controller_manager::ControllerSpec & a,
...
bool command_interface_is_reference_interface_of_controller(
  ...
  const std::vector<h6x_controller_manager::ControllerSpec> & controllers,
  h6x_controller_manager::ControllersListIterator & following_controller_it)
{
...
namespace h6x_controller_manager
{
...
: rclcpp::Node(manager_node_name, namespace_, options),
  ...
  executor_(executor),
  loader_(std::make_shared<pluginlib::ClassLoader<h6x_controller_interface::ControllerInterface>>(
  ...
  const ControllerSpec & controller)
{
  ...
  // ensure controller's `use_sim_time` parameter matches h6x_controller_manager's
